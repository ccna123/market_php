...
<body>
  ...
  <div class="container text-center card mt-5 text-dark px-5 py-5 w-75 .bg-light.bg-gradient"">
    ...
    <input type="email" id="inputEmai" class="form-control" placeholder="Email" name="email" autofocus>
    <br>
    ...
    <input type="password" id="inputPassword1" class="form-control" placeholder="Password" name="password" autofocus>
    ...
    <button type="submit" id="register" name="register" class="btn btn-lg btn-primary btn-block">Create Account</button>
    </form>
  </div>
